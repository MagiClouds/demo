...
func (c *greeterService) SayHello(ctx context.Context, in *SayRequest, opts ...client.CallOption) (*SayResponse, error) {
...
func (h *greeterHandler) SayHello(ctx context.Context, in *SayRequest, out *SayResponse) error {
