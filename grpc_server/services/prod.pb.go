...
type ProdListResponse struct {
	...
	ProdInfo []*ProdResponse `protobuf:"bytes,1,rep,name=prodInfo,proto3" json:"prodInfo,omitempty"`
}
...
func (x *ProdListResponse) GetProdInfo() []*ProdResponse {
	if x != nil {
		return x.ProdInfo
	}
	return nil
...
var file_prod_proto_rawDesc = []byte{
	...
	0x0a, 0x10, 0x50, 0x72, 0x6f, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x32, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x01,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x08, 0x70, 0x72,
	0x6f, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x32, 0x8e, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x64, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d, 0x0a, 0x0c, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x40, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x52,
...
var file_prod_proto_goTypes = []interface{}{
	...
	(*ProdListResponse)(nil), // 3: services.ProdListResponse
}
var file_prod_proto_depIdxs = []int32{
	1, // 0: services.ProdListResponse.prodInfo:type_name -> services.ProdResponse
	...
	3, // 4: services.ProdService.GetProdStocks:output_type -> services.ProdListResponse
...
type ProdServiceClient interface {
	...
	GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdListResponse, error)
}
...
func (c *prodServiceClient) GetProdStocks(ctx context.Context, in *QuerySize, opts ...grpc.CallOption) (*ProdListResponse, error) {
...
type ProdServiceServer interface {
	...
	GetProdStocks(context.Context, *QuerySize) (*ProdListResponse, error)
}
...
func (*UnimplementedProdServiceServer) GetProdStocks(context.Context, *QuerySize) (*ProdListResponse, error) {
